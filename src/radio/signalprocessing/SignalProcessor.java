...
public class SignalProcessor {
	 ...
	 * Nel particolare la potenza di un segnale discreto è pari alla somma del modulo quadro di ogni campione
	...
	public static AbstractSignal convolution(AbstractSignal s1, AbstractSignal s2) {
		...
		//la convoluzione avrà lunghezza pari alla somma del numero dei campioni dei segnali
